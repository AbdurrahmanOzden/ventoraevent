...
export const defaultSiteContent: SiteContent = {
  ...
  services: [
    ...
    {
      id: "svc5",
      title: "Sahne ve Teknik Prodüksiyon",
      shortDescription:
    ...
    {
      id: "svc6",
      title: "Kongre ve Toplantı Yönetimi",
      shortDescription:
        "Kongre, sempozyum ve kurumsal toplantılarda akış, içerik ve misafir deneyimi yönetimi.",
      detailedDescription:
        "Program mimarisinden salın düzenine, konuşmacı lojistiğinden kayıt süreçlerine kadar kongre ve toplantı organizasyonunu uçtan uca yönetiyoruz.",
      imageUrl: "/images/services/sahne-tasarimi.png",
      features: [
        { id: "f21", text: "Program ve oturum planı" },
        { id: "f22", text: "Kayıt ve badge yönetimi" },
        { id: "f23", text: "Salon ve teknik kurulum" },
        { id: "f24", text: "Konuşmacı lojistiği" },
      ],
      buttonText: "Hizmeti İncele",
      active: true,
      sortOrder: 6,
    ...
    {
      id: "svc7",
      title: "Kreatif Konsept Tasarımı",
      shortDescription:
    ...
    {
      id: "svc8",
      title: "Dijital ve Hibrit Etkinlikler",
      shortDescription:
        "Canlı yayın, hibrit katılım ve dijital etkileşimle genişleyen etkinlik deneyimleri.",
      detailedDescription:
        "Fiziksel sahneyi dijital kanallarla birleştiriyor; kayıt, yayın, moderasyon ve uzaktan katılımı aynı operasyonel ritimde yönetiyoruz.",
      imageUrl: "/images/service-ops.svg",
      features: [
        { id: "f29", text: "Canlı yayın kurgusu" },
        { id: "f30", text: "Hibrit katılım akışı" },
        { id: "f31", text: "Dijital etkileşim araçları" },
        { id: "f32", text: "Kayıt ve arşiv üretimi" },
      ],
      buttonText: "Hizmeti İncele",
      active: true,
      sortOrder: 8,
